...
### 1. Dockerfile
Le Dockerfile configure une image PHP 8.3 avec Apache, installe les dépendances et configure Laravel pour la production.
...
Les dépendances nécessitent PHP 8.3+. Modifiez :
